...
class Kuzzle extends EventEmitter {
  ...
  start (params = {}) {
    ...
    return Bluebird.resolve()
      ...
      .then(() => this.log.info(`[✔] Cache engine initialized - [${this.config.services.internalCache.backend}]`))
      .then(() => this.storageEngine.init())
      .then(() => this.internalIndex.init())
      .then(() => this.log.info(`[✔] Storage engine initialized - [${this.config.services.storageEngine.backend}]`))
      .then(() => {
