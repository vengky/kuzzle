...
class RoleRepository extends Repository {
  ...
  validateAndSaveRole (role, options) {
    return role.validateDefinition()
      .then(() => {
        ...
        return this.checkRoleControllersAndActions(role, this.kuzzle.funnel.controllers);
      })
   ...
   * @returns Promise
   */
  checkRoleControllersAndActions (role, controllers) {
